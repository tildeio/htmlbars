...
export function Placeholder(parent, startIndex, endIndex) {
  if (parent.nodeType === NodeTypes.DOCUMENT_FRAGMENT_NODE && (startIndex === -1 || endIndex === -1)) {
...
Placeholder.prototype = {
  parent: function () {
    if (this._parent.nodeType === NodeTypes.DOCUMENT_FRAGMENT_NODE && this._parent !== this.start.parentNode) {
...
export function appendHTML(parent, end, html) {
  var element;
  if (parent.nodeType === NodeTypes.DOCUMENT_FRAGMENT_NODE) {
