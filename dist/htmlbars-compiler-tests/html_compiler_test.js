...
var forEach = require("../htmlbars-compiler/utils").forEach;
var tokenize = require("../simple-html-tokenizer").tokenize;
var hydrationHooks = require("../htmlbars-runtime/hooks").hydrationHooks;
var DOMHelper = require("../morph").DOMHelper;
var normalizeInnerHTML = require("../test/support/assertions").normalizeInnerHTML;
